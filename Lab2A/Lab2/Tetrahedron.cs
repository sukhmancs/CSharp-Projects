 ...
 * Program's purpose - Tetrahedron class representing a tetrahedron
...
{
    /// <summary>
    /// Define a public class named "Tetrahedron" that inherits from a class called "Shape."
    /// </summary>
    public class Tetrahedron : Shape 
    {
        private double length; // Declare a private field to store the length of the tetrahedron's edges.
        ...
        public Tetrahedron() 
        {
            Type = "Tetrahedron"; // Set the "Type" property to "Tetrahedron" when an instance of the Tetrahedron class is created.
        }
        ...
        {
            return Math.Pow(length, 3) / 6 * Math.Sqrt(2); // Calculate and return the volume of the tetrahedron.
        }
        ...
        {
            return Math.Sqrt(3) * Math.Pow(length, 2); // Calculate and return the surface area of the tetrahedron.
        }
        ...
        {
            // Prompts the user to enter the length of the tetrahedron's edges.
        ...
        public override string ToString() 
        {
            return string.Format("{0, -20} {1, -19} {2, -17:0.00} {3, -10:0.00}",
                ...
                length, // The length of the tetrahedron's edges.
                CalculateArea(), // The surface area of the tetrahedron.
                CalculateVolume()); // The volume of the tetrahedron.
        }
    }
}
